...
- **Pendiente (10/08)**: rediseño visual del front ("todo el HTML y CSS y alguna tecnología para que quede bien bonito") — base actual Tailwind, fuentes Epilogue/Montserrat/JetBrains Mono, paleta `#068938`; Framer Motion opcional futuro. Después: documentación de uso de la página. **Deploy de todo el bloque presupuesto al final** (preferencia del usuario: todo local primero).
