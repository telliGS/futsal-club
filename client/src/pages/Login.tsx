          ...
          <div className="p-8 md:p-10 flex items-center">
            <div className="w-full max-w-sm mx-auto">
              ...
              <form onSubmit={submit} className="space-y-5">
                <div>
                  <label htmlFor="login-email" className="text-sm text-white/80 block mb-1.5 font-medium">Email</label>
                  <div className="relative">
                ...
                <div>
                  <label htmlFor="login-password" className="text-sm text-white/80 block mb-1.5 font-medium">Contraseña</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-white/40 text-lg">🔒</span>
                    <input
                      id="login-password"
