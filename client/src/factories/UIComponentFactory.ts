...
export interface UIComponentFactory {
  ...
  Container: ComponentType<{ children: ReactNode; className?: string }>;
  
  // Navigation
  NavLink: ComponentType<{ to: string; children: ReactNode; active?: boolean }>;
  MobileMenuButton: ComponentType<{ onClick: () => void }>;
  DesktopNav: ComponentType<{ links: NavLinkProps[] }>;
  MobileDrawer: ComponentType<{ isOpen: boolean; onClose: () => void; links: NavLinkProps[] }>;
  
  // Buttons
  PrimaryButton: ComponentType<ButtonProps>;
  SecondaryButton: ComponentType<ButtonProps>;
  GhostButton: ComponentType<ButtonProps>;
  
  // Cards
  Card: ComponentType<CardProps>;
  StatCard: ComponentType<StatCardProps>;
  InfoCard: ComponentType<InfoCardProps>;
  ...
  MobileCardList: ComponentType<MobileCardListProps>;
