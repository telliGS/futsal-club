...
export default function CalendarioView({ plantel, months, currentMonth, abrirPago }: ICalendarioViewProps) {
  return (
    <div className="mt-6">
      {/* Header + leyenda */}
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-3 text-[10px] font-mono uppercase tracking-wider text-white/50">
          <span className="flex items-center gap-1.5">
            <span className="inline-block w-3 h-3 rounded-md bg-primary/30 border border-primary/40" /> Pagó
          </span>
          <span className="flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className={cn('w-full h-8 inline-flex items-center justify-center rounded-md text-xs font-bold transition-all duration-150 active:scale-95',
                            esFuturo
                              ...
                              : paid
                                ? 'bg-primary/25 text-primary-light border border-primary/30 hover:bg-primary/40'
                                : marcado
